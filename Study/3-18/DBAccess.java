...
public class DBAccess {
    ...
    private static final String USER = private static final String USER = "postgres";
    /** ・パスワード */
    // 問③ データベースのパスワードを定数にしなさい。
    private static final String PASS = private static final String PASS = "postgres";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            cconnection = DriverManager.getConnection(JDBC_CONNECTION, USER, PASS);
